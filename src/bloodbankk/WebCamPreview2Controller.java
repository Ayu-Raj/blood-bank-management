 ...
 */
public class WebCamPreview2Controller implements Initializable {
	...
	public void stopCamera(ActionEvent event) throws IOException {
                grabbedImage = selWebCam.getImage();
		//final Image mainiamge = SwingFXUtils.toFXImage(grabbedImage, null);
                 File outputfile = new File("C:\\Users\\ayush\\Documents\\NetBeansProjects\\Bloodbankk\\src\\bloodbankk\\picPur\\"+PurSql.webid+".png");
		...
		btnStopCamera.setDisable(true);
                PurSql.callprint();
                AlertBox.display("Result","Purchased");
	}
